...
const Singup = () => {
  ...
  return (
    <section id="sign-in" className="bg-secondary px-[10%] py-[5%] text-white gap-4 grid grid-cols-1 sm:grid-cols-2">
      <div className="space-y-4">
        <p className="raleway raleway text-center sm:text-left sm:text-4xl"> Get early access today</p>
